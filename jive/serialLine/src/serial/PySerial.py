...
class PySerial (PyTango.Device_4Impl):
    ...
    def dev_state(self):
        ...
        #----- PROTECTED REGION ID(PySerial.State) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	PySerial.State
    ...
    def dev_status(self):
        ...
        argout = ""
        #----- PROTECTED REGION ID(PySerial.Status) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	PySerial.Status
