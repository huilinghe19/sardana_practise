 ...
 */
//--------------------------------------------------------
Tango::DevState Socket::dev_state()
{
	DEBUG_STREAM << "Socket::State()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(Socket::dev_state) ENABLED START -----*/
	
	Tango::DevState	argout = Tango::UNKNOWN; // replace by your own algorithm
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	Socket::dev_state
 ...
 */
//--------------------------------------------------------
Tango::ConstDevString Socket::dev_status()
{
	DEBUG_STREAM << "Socket::Status()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(Socket::dev_status) ENABLED START -----*/
	
	string	status = "Device is OK";
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	Socket::dev_status
