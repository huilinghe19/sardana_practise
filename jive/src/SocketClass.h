...
public:
	...
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<Socket *>(dev))->read_hostname(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<Socket *>(dev))->is_hostname_allowed(ty);}
};

//	Attribute port class definition
class portAttrib: public Tango::Attr
{
public:
	portAttrib():Attr("port",
			Tango::DEV_ULONG, Tango::READ) {};
	~portAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<Socket *>(dev))->read_port(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<Socket *>(dev))->is_port_allowed(ty);}
};
...
//	Command WriteReadCharArray class definition
class WriteReadCharArrayClass : public Tango::Command
{
public:
	WriteReadCharArrayClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	WriteReadCharArrayClass(const char   *name,
				   ...
				   Tango::CmdArgType out)
	:Command(name,in,out)	{};
	~WriteReadCharArrayClass() {};
	
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<Socket *>(dev))->is_WriteReadCharArray_allowed(any);}
};
