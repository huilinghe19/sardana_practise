static const char *RcsId = "$Header: /users/chaize/newsvn/cvsroot/Communication/Socket/src/Socket.cpp,v 1.1.1.1 2007-01-12 10:07:44 pascal_verdier Exp $";
//+=============================================================================
//
// file :         Socket.cpp
//
...
Tango::DevString Socket::read()
{
	...
	{
		manage_exception(e.description(), "Socket::read()");
	}
}
